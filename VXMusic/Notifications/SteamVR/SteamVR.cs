...
//
//     private static readonly float[] _rotationLeft =
//         { 90f * (float)(Math.PI / 180f), 90f * (float)(Math.PI / 180f), -90f * (float)(Math.PI / 180f) };
//
//     private static readonly float[] _rotationRight =
//         { -90f * (float)(Math.PI / 180f), -90f * (float)(Math.PI / 180f), -90f * (float)(Math.PI / 180f) };
//
...
//                         }
//
//                         err = ProcessOverlay1(overlay, ref overlayHandle1, ref overlayVisible1, dashboardVisible,
...
//                 var batteryPercentage = system.GetFloatTrackedDeviceProperty(i,
...
//                 var isCharging =
//                     system.GetBoolTrackedDeviceProperty(i, ETrackedDeviceProperty.Prop_DeviceIsCharging_Bool, ref err);
//                 if (err != ETrackedPropertyError.TrackedProp_Success)
//                 {
//                     isCharging = false;
//                 }
//
//                 sb.Clear();
//                 system.GetStringTrackedDeviceProperty(i, ETrackedDeviceProperty.Prop_TrackingSystemName_String, sb,
//                     (uint)sb.Capacity, ref err);
...
//                 _browser1.GetBrowserHost().SendMouseMoveEvent((int)(m.x * s.Width), s.Height - (int)(m.y * s.Height),
...
//                 var m = e.data.mouse;
//                 var s = _browser1.Size;
//                 _browser1.GetBrowserHost().SendMouseClickEvent((int)(m.x * s.Width), s.Height - (int)(m.y * s.Height),
...
//     }
//
//     internal EVROverlayError ProcessOverlay1(CVROverlay overlay, ref ulong overlayHandle, ref bool overlayVisible,
//         bool dashboardVisible, uint overlayIndex, DateTime nextOverlay)
//     {
//         var err = EVROverlayError.None;
//
//         if (overlayHandle == 0)
...
//     }
//
//     internal EVROverlayError ProcessOverlay2(CVROverlay overlay, ref ulong overlayHandle, ref bool overlayVisible,
...
//                     m11 = m.M43
//                 };
//                 err = overlay.SetOverlayTransformTrackedDeviceRelative(overlayHandle, OpenVR.k_unTrackedDeviceIndex_Hmd,
//                     ref hm34);
//                 if (err != EVROverlayError.None)
//                 {
//                     return err;
